...
import { collectReviewContext, resolveBaselineRef, resolveReviewTarget } from "../plugins/claude-companion/scripts/lib/git-context.mjs";

async function git(cwd, args) {
  const { runCommand } = await import("../plugins/claude-companion/scripts/lib/process.mjs");

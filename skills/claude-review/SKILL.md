---
name: claude-review
description: Use when the user wants Claude Code, through Claude Companion, to review code, review risks, or adversarially challenge an implementation or design from inside Codex.
---

# Claude Review

Use this skill to delegate read-only review to Claude Code through the Claude Companion CLI. The companion is a CLI-only plugin surface; do not start, configure, or invent MCP behavior.
